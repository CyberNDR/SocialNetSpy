...
print("Disclaimer:")
print("-----------------------------------------------------------------------------------------------------------------------------")
print("THE CREATOR OF THIS TOOL ASSUMES NO LIABILITY FOR THE IMPROPER USE OF THIS INTELLIGENCE TOOL BY THE USER. USE IT RESPONSIBLY.")
print("-----------------------------------------------------------------------------------------------------------------------------")
time.sleep(2)
print("\n")
print("-------------------")
...
def main():
	...
	if maininput == "99":
		...
		print("• SocialNetSpy is an information gathering tool based on Python. It obtains all the target's social network profiles and general informations (web footprint) querying the Google database through operators.")
		print("• SocialNetSpy processes targets like name and surname, nicknames, usernames, companies and whatever is registered on the internet.")
		print("• SocialNetSpy can find anyone by a simple input.")
		time.sleep(3)
		print("\n")
		print("-----------------------------")
		print("        SOCIALNETSPY        |")
